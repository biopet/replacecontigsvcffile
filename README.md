...
#  About this tool
This tool replaces contig names in a VCF file. For example `chr1` -> `1`.

#  Documentation
For documentation and manuals visit the [readthedocs page](http://biopet-ReplaceContigsVcfFile.readthedocs.io/en/latest/).
